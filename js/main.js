import { initApp } from "./ui/app.js?v=15";
import { initGridBorderPanel } from "./ui/panels/gridBorderPanel.js?v=15";
import { initLayoutResolutionPanel } from "./ui/panels/layoutResolutionPanel.js?v=15";
import { initLayoutComposerPanel } from "./ui/panels/layoutComposerPanel.js?v=15";
import { initColorKeyPanel } from "./ui/panels/colorKeyPanel.js?v=15";
import { initBatchStoryboardPanel } from "./ui/panels/batchStoryboardPanel.js?v=15";
import { initGalleryPanel } from "./ui/panels/galleryPanel.js?v=15";
import { initPreviewGalleryPanel } from "./ui/panels/previewGalleryPanel.js?v=15";
import { initExportPanel } from "./ui/panels/exportPanel.js?v=15";
import { initPdfPreviewPanel } from "./ui/panels/pdfPreviewPanel.js?v=15";
