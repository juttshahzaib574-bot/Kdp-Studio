...
import {
  ...
  clampDpi,
  getTrimSizeById,
} from "../modules/canvasEngine.js?v=40";
import { computeCanvasDimensions, needsRiskWarning } from "../modules/bleedEngine.js?v=40";
import { computeSafeZone } from "../modules/safeZoneEngine.js?v=40";
import { drawPreview } from "./preview.js?v=40";
